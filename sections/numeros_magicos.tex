...
%No modelo de jelium esférico, os núcleos iônicos são substituídos por um fundo de carga positiva uniforme de raio RR.  O parâmetro básico do modelo é o raio de Wigner-Seitz rsrs definido na Eq. (16,1). Além disso, a função de onda para um potencial esfericamente simétrico pode ser escrita como
